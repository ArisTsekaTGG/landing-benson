  ...
  >
    <defs>
      ...
      <linearGradient id="ua-gold" x1="0" y1="0" x2="1" y2="1">
        ...
        <stop offset="50%" stopColor="#1f4da6" />
        <stop offset="100%" stopColor="#0f2e63" />
      </linearGradient>
      ...
      <radialGradient id="ua-spot" cx="50%" cy="50%" r="60%">
        <stop offset="0%" stopColor="#2554a0" stopOpacity="0.18" />
        <stop offset="100%" stopColor="#2554a0" stopOpacity="0" />
      </radialGradient>
    </defs>

    <rect width="480" height="600" fill="url(#ua-bg)" />
    <rect width="480" height="600" fill="url(#ua-spot)" />
    <path d="M40 540 Q240 510 440 540" stroke="#1f4da6" strokeWidth="1" fill="none" opacity="0.4" />

    {/* stack of bills */}
    <g transform="translate(110 240)">
      {/* bottom bill */}
      <rect x="0" y="60" width="240" height="120" rx="6" fill="url(#ua-bill)" stroke="#1f4da6" strokeWidth="1.4" transform="rotate(-4 120 120)" />
      <rect x="20" y="80" width="200" height="80" rx="4" fill="#ece2c9" opacity="0.6" transform="rotate(-4 120 120)" />
      {/* mid bill */}
      <rect x="20" y="40" width="240" height="120" rx="6" fill="url(#ua-bill)" stroke="#1f4da6" strokeWidth="1.4" transform="rotate(2 140 100)" />
      <rect x="36" y="56" width="208" height="82" rx="4" fill="#ece2c9" opacity="0.4" transform="rotate(2 140 100)" />
      {/* top bill */}
      <g transform="rotate(-1 140 80)">
        <rect x="20" y="20" width="240" height="120" rx="6" fill="url(#ua-bill)" stroke="#1f4da6" strokeWidth="1.6" />
        ...
        <text x="220" y="130" textAnchor="end" fontFamily="Georgia" fontSize="22" fontWeight="700" fill="#163d85">
          OVERDUE
        </text>
      </g>
    </g>
    ...
    <g transform="translate(240 130)">
      ...
      <circle cx="0" cy="0" r="32" fill="url(#ua-gold)" stroke="#b0c8e8" strokeWidth="2" />
