...
export const EligibilityForm = () => {
  ...
  return (
    ...
    >
      {/* Frosted glass card on the navy hero */}
      <div className="glass-light relative overflow-hidden rounded-[24px] p-6 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.45)] sm:p-7">
        <div className="relative">
          <div className="mb-1 flex items-baseline gap-2">
            <h3 className="font-display text-[1.4rem] font-semibold leading-tight text-blue-900">
              Check your eligibility
            </h3>
          </div>
          <p className="mb-5 text-[0.95rem] text-blue-700">
            in <span className="font-italic">60 seconds.</span>
          </p>
          ...
          <AnimatePresence mode="wait">
            {!submitted ? (
              ...
              >
                {FIELDS.map((field, idx) => (
                  <motion.label
                    ...
                    className="block"
                  >
                    <span className="mb-1.5 block text-[0.78rem] font-medium text-blue-900/80">
                      {field.label}
                    </span>
                    <div className="group relative">
                      <select
                        ...
                        className={cn(
                          "w-full appearance-none rounded-xl border border-blue-100 bg-blue-50/40 px-4 py-3 text-[0.92rem] text-blue-900 outline-none transition-all",
                          "focus:border-blue-700 focus:bg-white focus:ring-4 focus:ring-blue-100",
                      ...
                      <svg
                        className="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-blue-700 transition-colors"
                        viewBox="0 0 16 16"
                        fill="none"
                        aria-hidden
                      >
                ...
                <motion.button
                  ...
                  className={cn(
                    "btn-blue group relative mt-1 inline-flex w-full items-center justify-center gap-2 rounded-xl px-5 py-3.5 text-[0.96rem] font-semibold transition-all",
                ...
                <p className="mt-1 flex items-center justify-center gap-1.5 text-[0.74rem] text-blue-900/55">
              ...
              >
                ...
                <h4 className="font-display text-xl font-semibold text-blue-900">You look eligible.</h4>
                <p className="max-w-xs text-[0.92rem] text-blue-900/70">
                ...
                <button
                  ...
                  className="mt-2 text-[0.82rem] font-medium text-blue-700 underline-offset-4 hover:underline"
                >
                  Start a new check
                </button>
              </motion.div>
